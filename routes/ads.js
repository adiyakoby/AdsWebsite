...
router.get('/userAds', isUser ,apiController.getUserAds);  // Route to post a new ad
// Admin routes
...
router.delete('/ads/:id', isUser, apiController.deleteAd); // Route to delete an ad (admin only)
